	...
	public abstract class XStreamUtil {
		...
		public static String TAG_METHOD_CALL = "methodcall";
		public static String TAG_CALLED_METHODS = "calledmethods";
		public static String TAG_METHOD_ENTRY_EVENT = "methodentryevent";
		public static String TAG_METHOD_EXIT_EVENT = "methodexitevent";
		public static String TAG_SIMPLE_DATA = "simplevariable";
		public static String TAG_OBJECT = "objectvariable";
		public static String TAG_ARRAY = "arrayvariable";
		public static String TAG_STRING = "stringvariable";
		...
		public static String TAG_THIS = "objectthis";
		...
		public static String TAG_THREAD_INFO = "threadinfo";
