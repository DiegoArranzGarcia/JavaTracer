...
{
    public static final ImageIcon CROSS_ICON = new ImageIcon ( WebFileChooserField.class.getResource ( "cross.png" ) );
    ...
    public class FilePlate extends WebPanel
    {
        public FilePlate ( final File file )
        {
            ...
            final String absolutePath = getPath(file.getAbsolutePath());
        ...
        private String getPath(String absolutePath) {
        	...
        	int max_length = 50;
			if (absolutePath.length()>max_length){
				path = "..." + absolutePath.subSequence(absolutePath.length()-max_length,absolutePath.length());
			}
			return path;
		}
    ...
    public void setCurrentDirectory(String path){
    	webFileChooser.setCurrentDirectory(path);
    }

	public void setFileFilter(FileNameExtensionFilter filter) {
		webFileChooser.setFileFilter(filter);
	}

	public void setTitle(String string) {
		webFileChooser.setDialogTitle(string);
	}
}
